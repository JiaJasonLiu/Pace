import { LifestyleGoal, Wallet, Transaction, Category, LifestyleSettings, MotivationalEarning } from '../../../types';
...
export interface LifestyleViewProps {
  ...
  onUpdateMotivationalEarning: (motivationalEarning: MotivationalEarning) => void;
