...
import { Trash2, Edit2, TrendingUp, Target, Calendar, CheckCircle2 } from 'lucide-react';
...
export function WalletModal({ 
  ...
  }, [editingWallet, isFirstWallet, isOpen]);
  ...
  const handleDelete = () => {
    if (editingWallet && window.confirm("Are you sure you want to delete this wallet?")) {
  ...
  return (
    ...
    >
      <form id="wallet-form" onSubmit={handleSubmit} className="space-y-3">
        ...
        <p className="text-center text-xs text-slate-400 font-medium -mt-2 mb-4">Current Balance</p>
